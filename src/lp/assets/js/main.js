(function ($) {
	...
	$('.popup-image5').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
	});
	$('.popup-image6').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
	});
	$('.popup-image7').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
	});
	$('.popup-image8').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
	});
	$('.popup-image9').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
	});
	$('.popup-image10').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
	});
	$('.popup-image11').magnificPopup({
		type: 'image',
		gallery: {
			enabled: true
		}
